...
def parse_args(args=None):
    ...
    parser.add_argument('-dr', '--double_relation_embedding',
                        action='store_true', default=False)

    # ===== 训练超参数 =====
    parser.add_argument('-n', '--negative_sample_size', type=int, default=256)
    parser.add_argument('-d', '--hidden_dim', type=int, default=1000)
    parser.add_argument('-g', '--gamma', type=float, default=24.0)

    parser.add_argument('-adv', '--negative_adversarial_sampling',
                        action='store_true', default=True)
    parser.add_argument('-a', '--adversarial_temperature', type=float, default=1.0)
